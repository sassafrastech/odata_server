module OData::ActiveRecordSchema::Mixins
  module OptionTranslator
    ...
    def translate_filter(scope, predicate, left, right)
      # The code in this method seems fundamentally insecure since it is dropping user
      # input directly into a where clause without escaping it. If we decide to enable this functionality
      # it will need to be carefully tested and likely refactored.
      return scope
